...
function EditArtistPage() {
  ...
  const handleFormSubmit = (e) => {
    ...
    const requestBody = { firstName, lastName, description, email, social1, social2, social3, imageUrl };
    const storedToken = localStorage.getItem("authToken");
 
    // Make a PUT request to update the artist
    axios
    .put(`${API_URL}/artists/${artistId}/edit`, requestBody, { headers: { Authorization: `Bearer ${storedToken}` } })
      .then((response) => {
...
const deleteArtist = () => {
    ...
    axios
    .delete(`${API_URL}/artists/${artistId}`, { headers: { Authorization: `Bearer ${storedToken}` } })
      .then(() => {
      ...
      <h3>Edit Item</h3>
        ...
        <div className="form-outer-container">
            ...
            <div className="form-container">
                <label className="form-label">Social media link 1</label><br />
                <input
                type="text"
                name="social1"
                value={social1}
                ...
                <label className="form-label">Social media link 2</label><br />
                <input
                type="text"
                name="social2"
                value={social2}
                ...
                <label className="form-label">Social media link 3</label><br />
                <input
                type="text"
                name="social3"
                value={social3}
        ...
        <button type="submit" className="form-button">Save</button><span className="text-xs">&nbsp;&nbsp;&nbsp;OR&nbsp;&nbsp;&nbsp;</span><button onClick={deleteArtist} className="form-button">Delete</button>
        </form>
        <br /><br />
    </div>
    </div>
