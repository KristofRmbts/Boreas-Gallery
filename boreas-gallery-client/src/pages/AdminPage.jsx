    ...
    <div className="body-container">
      ...
      <div className="admin-container">
        <div className="admin-inner-container border">
          ...
          {artists.map((artist) => (
            <div key={artist._id}>
              <ul className="admin-listitem">
                <li>
                  <Link to={`/artists/${artist._id}`} className="admin-links">
                    <span>
                      {artist.firstName} {artist.last}
                    </span>
                  </Link>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <Link to={`/artists/${artist._id}/edit`}>
          ...
          <br />
          <Link to={`/artists/add`}>
            <button className="small-button">ADD ARTIST</button>
          </Link>
          <br />
          <br />
        </div>
        <div className="admin-inner-container border">
            ...
            <div key={exhibition._id}>
              <ul className="admin-listitem">
                <li>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <Link to={`/exhibitions/${exhibition._id}/edit`}>
                    <button className="small-button">EDIT</button>
                  </Link>
                  &nbsp;&nbsp;
                </li>
          ...
          <Link to={`/exhibitions/add`}>
            <button className="small-button">ADD EXHIBITION</button>
          </Link>
          <br />
          <br />
        </div>
        <div className="admin-inner-container border">
          ...
          {items.map((item) => (
            <div key={item._id}>
              <ul className="admin-listitem">
                <li>
                  <Link to={`/shop/${item._id}`} className="admin-links">
                    <span>{item.title}</span>
                  </Link>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <Link to={`/shop/${item._id}/edit`}>
                    <button className="small-button">EDIT</button>
                  </Link>
                  &nbsp;&nbsp;
                </li>
