      ...
      <div className="footer-inner-container">
        ...
        <nav className="footer-links-container">
          <div className="footer-container-left">
            <Link to="/about" className="link-white link-margin">
              {" "}
              About us{" "}
            </Link>
            <Link to="/takepart" className="link-orange link-margin">
              {" "}
              Take part{" "}
            </Link>
          </div>
          <div className="footer-container-right">
            {isAdmin && (
              <Link to="/admin" className="link-white link-margin">
                {" "}
                Admin Portal{" "}
              </Link>
            )}
            {!isLoggedIn && (
              <Link to="/login" className="link-white">
                {" "}
                Login{" "}
              </Link>
            )}
            {isLoggedIn && (
              <Link onClick={logOutUser} className="link-white">
                {" "}
                Logout{" "}
              </Link>
            )}
